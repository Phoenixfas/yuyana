...
export default function HeroSection() {
  ...
  return (
    <div className='w-full overflow-hidden flex pt-40'>
        ...
        <div className="flex-[1] relative ">
            <motion.div initial={{x: 300, opacity: 0}} animate={{x: 0, opacity: 1}} transition={{duration: 2, damping: 10, bounce: 0.8, type: "spring", delay: .3 }} className="flex-[1] flex flex-col items-start tracking-[1rem] text-[5rem] text-[#FEA100] font-bold left-[-25%] relative">
                CONTACT US
            </motion.div>
            <motion.div initial={{x: 300, opacity: 0}} animate={{x: 0, opacity: 1}} transition={{duration: 1}} className="flex-[1] flex flex-col items-start text-lg pr-40">
