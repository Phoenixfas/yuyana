  ...
  return (
    <div className="mt-32 w-full overflow-hidden flex justify-center">
        <div className='border border-[#131316] rounded-xl py-10 px-20 flex flex-col items-center'>
            ...
            <h1 className='text-3xl text-center text-[#131316] mb-7 font-bold'>Book This Tour Package</h1>
            <Link href='/packages/book' className='px-5 py-2 rounded-full bg-[#04ac3c] text-[#fff4db] hover:bg-[#FEA100] hover:text-[#fff4db] duration-300'>Book Now</Link>
        </div>
    </div>
  )
}
