...
export default function Browse() {
  ...
  return (
    <div className='px-[90px] py-40 text-[#fff4db] flex flex-col items-center justify-center'>
        <h1 className='text-3xl font-black mb-14'>CHOOSE YOUR NEXT DESTINATION</h1>
        <div className="w-full flex justify-between">
            {localTours.map((tour: any, index) => (
                <div key={index} className="flex flex-col items-center justify-between text-center w-[200px] transition-colors cursor-pointer max-h-[250px] box-border  rounded-lg browse-hover">
            ...
            <div className="flex flex-col items-center justify-between text-center w-[200px] transition-colors cursor-pointer max-h-[250px] box-border  rounded-lg browse-hover">
