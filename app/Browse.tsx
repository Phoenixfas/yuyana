  ...
  return (
    <div className='px-[90px] py-[120px] bg-white flex flex-col items-center justify-center'>
        ...
        <div className="flex gap-5">
            <div className="flex flex-col items-center justify-between max-w-[230px] transition-colors cursor-pointer max-h-[250px] box-border hover:bg-[#FEA100] pt-1 pb-5 rounded-lg">
