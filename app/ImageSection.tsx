...
export default function ImageSection() {
    ...
    const isInView = useInView(ref, { margin: margin, once: false})
      ...
      <ParallaxProvider>
        ...
        <div className="flex flex-col max-w-[900px] items-center absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] z-1 justify-center text-white m-auto p-10">
          <Parallax speed={10} className="flex flex-col items-center" >
            ...
            <motion.h1 animate={controls} variants={variants2} className={`text-[5rem] leading-[5.3rem] text-center font-normal font-serif mb-8 mt-5 `} >Addis At Night</motion.h1>
