  ...
  return (
    <div ref={ref} className='w-full overflow-hidden h-[100vh] relative'>
      <ParallaxProvider>
          ...
          <div className="flex flex-col max-w-[900px] items-center absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] z-1 justify-center text-white m-auto p-10">
          <Parallax speed={10} className="flex flex-col items-center" >
              ...
              <motion.h1 animate={controls} variants={variants2} className='home-img-h1 text-[5rem] leading-[5.3rem] text-center font-normal font-sans mb-8 mt-5'><motion.span animate={controls} variants={variants1} >THE </motion.span><motion.span animate={controls} variants={variants2} >DANAKIL </motion.span><motion.span animate={controls} variants={variants3} >DESERT</motion.span></motion.h1>
